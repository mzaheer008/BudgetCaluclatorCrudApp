...
var UIController = (function() {
    ...
    var DOMstrings = {
        ...
        percentageexpensesLabel: '.budget__expenses--percentage',
        container: '.container',
    ...
    return {
        ...
        displayBudget : function(obj) {
            ...
            if (obj.percentage > 0){
                document.querySelector(DOMstrings.percentageexpensesLabel).textContent = obj.percentage + '%';   
            } else {
                document.querySelector(DOMstrings.percentageexpensesLabel).textContent = '---';
            }
        },
...
var controller = (function(budgetCtrl, UICtrl){
    ...
    var ctrlAdditem = function() {
        ...
        // 6. Calculate and update percentgaes
        updatePercentages();
